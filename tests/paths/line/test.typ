...
#test-all-angles(obj => paths.path-effect(obj, corner-radius: 0.1))

#pagebreak()

#test-all-angles(obj => paths.path-effect(obj, extrude: (+2, 0, -2)))

#pagebreak()

#test-all-angles(obj => paths.path-effect(obj, corner-radius: 0.1, extrude: (+2, 0, -2)))
...
#cetz.canvas({
  ...
  (
    arguments(corner-radius: 0.1),
    arguments(extrude: (+2, 0, -2)),
    arguments(corner-radius: 0.0, extrude: (+2, 0)),
    arguments(corner-radius: 0.0, extrude: (-2, 0)),
    arguments(corner-radius: 0.1, extrude: (2, 0, -2)),
  ).map(args => {
